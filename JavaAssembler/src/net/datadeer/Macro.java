...
public class Macro {
    final static Macro[] MACROS = {
            ...
            new Macro("addi8",(a) -> CommandFactory.CommandGroup.create(new String[]{
                    "set RAT", "clr", "ori "+(Integer.parseInt(a)%16),"ori "+(Integer.parseInt(a)/16), "add RAT"
            })),
            ...
            new Macro("setml",(a) -> CommandFactory.CommandGroup.create(new String[]{
                    "set RAT",
                    "clr","xori "+(Integer.parseInt(a)/256)%16, "xori "+(Integer.parseInt(a)/4096)%16, "set RMH",
                    "clr","xori "+(Integer.parseInt(a)%16), "xori "+(Integer.parseInt(a)/16)%16, "set RML",
                    "get RAT"
            })),
            new Macro("setsl",(a) -> CommandFactory.CommandGroup.create(new String[]{
                    "set RAT",
                    "clr","xori "+(Integer.parseInt(a)/256)%16, "xori "+(Integer.parseInt(a)/4096)%16, "set RSH",
                    "clr","xori "+(Integer.parseInt(a)%16), "xori "+(Integer.parseInt(a)/16)%16, "set RSL",
                    "get RAT"
            })),
